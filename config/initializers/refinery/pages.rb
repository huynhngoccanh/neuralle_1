...
Refinery::Pages.configure do |config|
  ...
  # config.friendly_id_reserved_words = ["index", "new", "session", "login", "logout", "users", "refinery", "admin", "images", "wymiframe", "contact", "submit"]
  ...
  config.add_whitelist_elements = %w[ script noscript video source iframe ]
  ...
  # config.add_whitelist_attributes = %w[ src ]
end
